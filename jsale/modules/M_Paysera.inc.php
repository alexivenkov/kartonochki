<?php
# Модуль оплаты заказа с помощью сервиса Paysera
...
class M_Paysera
{
	...
	*/
	public function InitiatePayment($projectID, $password, $orderID, $sum, $currencyCode, $countryCode, $successURL, $failURL, $checkURL, $test)
	{
	...
	*/
	...
	public function CheckResult($projectID, $password, $test)
	{
		...
		if (!$response || $response['test'] !== '0' && $test !== true || $response['type'] !== 'macro')
			return false;
