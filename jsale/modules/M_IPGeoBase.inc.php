<?php
// Модуль оплаты заказа с помощью сервиса Maxmind.com
...
class M_IPGeoBase
{
	...
	public static function Instance($geo_params)
	{
		if (self::$instance == null)
			self::$instance = new M_IPGeoBase($geo_params);
   ...
   public function __construct($options = null) {
	...
	function get_value($key = false, $cookie = true)
	{
		...
		elseif($cookie && !isset($_COOKIE['geobase']))
		{
		...
		if ($key)
			...
			return (isset($data)) ? $data : ''; // иначе возвращаем массив со всеми данными            
	}
