...
$config['form']['phone']['enabled']			= false;
$config['form']['phone']['required']		= false;
...
$config['form']['add']['color']['label']	= 'Цвет!!!:';
$config['form']['add']['color']['type']		= 'select';
$config['form']['add']['color']['select']	= array ('Красный' => 'Красный', 'Чёрный (+200 рублей)' => 'Чёрный (+200 рублей)');
$config['form']['add']['color']['cost']		= array ('Красный' => 0, 'Чёрный (+200 рублей)' => 200);
$config['form']['add']['color']['enabled']	= false;
$config['form']['add']['color']['required']	= false;
$config['form']['add']['color']['empty']	= 'Введите, пожалуйста, цвет';

$config['form']['add']['opt']['label']		= 'Дополнительная опция (+500 рублей):';
$config['form']['add']['opt']['type']		= 'checkbox';
$config['form']['add']['opt']['checkbox']	= 'Включена';
$config['form']['add']['opt']['cost']		= array ('Включена' => 500);
$config['form']['add']['opt']['enabled']	= true;
...
# Отправка курьеру
$config['payments']['courier']['enabled']			= ($admin === true) ? true : false;;
...
# Настройки RoboKassa
$config['payments']['robokassa']['enabled']			= true;    # Использовать RoboKassa?
...
$config['payments']['yandex_eshop']['shop_id']		= '17469'; # Идентификатор магазина
$config['payments']['yandex_eshop']['scid']			= '8959'; # Идентификатор товара
$config['payments']['yandex_eshop']['token']		= ''; # Токен
...
$config['deliveries']['0']['enabled']		= ($admin === true) ? true : false; # Использовать?
$config['deliveries']['0']['title']			= 'Самовывоз'; # Название в выпадающем меню
$config['deliveries']['0']['info']			= 'Забираете товар самостоятельно на складе.';# Описание
$config['deliveries']['0']['details']		= ''; # Детали (будут высланы на email)
$config['deliveries']['0']['cost']			= '0'; # Стоимость (будет добавлено к стоимости заказа)
$config['deliveries']['0']['free']			= ''; #Сумма заказа, более которой доставка будет бесплатна. Если не нужна, оставьте поле пустым
...
$config['deliveries']['1']['cost']			= '100'; # Стоимость (будет добавлено к стоимости заказа)
