...
# Тип формы
$feedback = true;
$form_type = $product['form_type'] = (isset($_POST['form_type'])) ? $_POST['form_type'] : $config['feedback']['form_type'];

# Выбор шаблона
$feedbackForm = (!empty($_POST['template'])) ? 'feedbackForm_' . (int) $_POST['template'] : 'feedbackForm';

# Обёртка шаблона формы
ob_start();
include_once dirname(__FILE__) . "/../design/$feedbackForm.tpl.php";
