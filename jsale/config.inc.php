...
$config['sitelink']							= 'http://dev.kartonochki.ru/'; # Адрес сайта (со слэшем на конце)
#$config['sites']							= array ('jsale.biz'); # Домены сайтов, где будет также работать скрипт. Закомментировать, если не нужно.
$config['sitename']							= 'Kartonochki.ru'; # Название магазина
...
$config['email']['receiver']				= 'dr.oink@gmail.com'; # E-mail адрес, на который отправляется заказ
$config['email']['answer']					= 'dr.oink@gmail.com'; # E-mail адрес, от имени которого отправляется ответное письмо покупателю
$config['email']['from_customer']			= false; # Присылать продавцу письма от имени покупателя? true/false
$config['email']['answerName']				= 'zakaz@kartonochki.ru';	# Имя робота
$config['email']['answerMessageTop']		= '<h3>Привет! Спасибо за заказ на ' . $config['sitename'] . '!</h3><br>'; # Ответное письмо покупателю
$config['email']['answerMessageSignature']	= '<p>--------------<br> </p>'; # Подпись в письме
$config['email']['subjectOrder']			= 'Ваш заказ №№ на сайте «' . $config['sitename'] . '» принят!'; # Тема письма о заказе
...
$config['database']['user']					= 'kartonocru_dev'; # Пользователь
$config['database']['pass']					= '1q2w3e4r'; # Пароль
...
$config['deliveries']['0']['enabled']		= false;
$config['deliveries']['0']['title']			= 'Курьер СДЭК';
$config['deliveries']['0']['info']			= 'Экспресс-доставка домой или в офис за 2-4 дня';
$config['deliveries']['0']['details']		= '';
$config['deliveries']['0']['cost']			= '';
$config['deliveries']['0']['free']			= '2800';

$config['deliveries']['1']['enabled']		= false; # Использовать?
$config['deliveries']['1']['title']			= 'Почта России'; # Название в выпадающем меню
$config['deliveries']['1']['info']			= 'Посылка 1 класса до ближайшего почтового отделения. Идет 5-7 дней'; # Описание
$config['deliveries']['1']['details']		= ''; # Детали (будут высланы на email)
$config['deliveries']['1']['cost']			= ''; # Стоимость (будет добавлено к стоимости заказа)
...
$config['deliveries']['2']['info']			= 'Пункт выдачи заказов. Та же курьерская доставка за 2-4 дня, но с самовывозом';
$config['deliveries']['2']['details']		= '';
$config['deliveries']['2']['cost']			= '';
...
$config['codes']['enabled']					= false; # Использовать купонные скидки?
...
$config['form']['name']['required']			= false;
...
$config['form']['address']['enabled']		= false;
...
$config['feedback']['email']['enabled']		= false; # Используется
$config['feedback']['email']['required']	= false; # Обязательное поле

$config['feedback']['name']['label']		= 'Ваше имя:';
$config['feedback']['name']['enabled']		= true;
$config['feedback']['name']['required']		= false;

$config['feedback']['phone']['label']		= 'Телефон для связи:';
$config['feedback']['phone']['enabled']		= true;
$config['feedback']['phone']['required']	= true;

$config['feedback']['comment']['label']		= 'Модель телефона, который нужно проверить:';
$config['feedback']['comment']['enabled']	= true;
$config['feedback']['comment']['required']	= true;
...
$config['call']['operators']				= array (
												array('name' => 'Екатерина Исламова'),
												array('name' => 'Мария Султанова')
											);
...
$config['admin']['login']					= 'admin'; # Логин админки
$config['admin']['password']				= '63827f95ea84aa66e435077654bb2629'; # Пароль админки. Хранится в зашифрованом виде. Получить шифр пароля можно здесь: http://pr-cy.ru/md5
...
$config['sms']['sdekSent2customer']['enabled']	= true; # Включить АВТОМАТИЧЕСКОЕ SMS уведомление при изменения статуса на Отправлено покупателю (если указан трек-номер и метод доставки СДЭК)?
$config['sms']['sdekSent2customer']['delivery']	= 0; # Идентификатор метода доставки, при которомо срабатывает отправка SMS
