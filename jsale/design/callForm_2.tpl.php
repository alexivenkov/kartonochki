<form action="<?= $config['sitelink'] . $config['dir'] ?>call/relay.php" method="post" class="jSaleForm jSaleCall">
	...
	<? endif; ?>
	<p class="submit">
		<input type="submit" name="order_submit" value="Отправить сообщение!" class="jSaleSubmit jSaleButton">
		...
		<input type="hidden" name="template" value="<? preg_match('/callForm\_(.*).tpl.php/', __FILE__, $file); if (isset($file[1])) echo $file[1]; ?>">
